...
from backend.models import User, Contact, Category, Shop, Product, Order, ProductInfo, ProductParameter, OrderItem
...
class UserSerializer(ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ('id', 'first_name', 'email', 'company', 'position', 'contacts')
        read_only_fields = ('id',)
